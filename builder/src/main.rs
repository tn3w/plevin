...
pub const FIELDS: &[(&str, &[&str])] = &[
    ...
    ("place.country.area", COUNTRY),
    ("place.country.borders", COUNTRY),
    ("place.country.bounds", COUNTRY),
    ("place.country.calling_code", COUNTRY),
    ("place.country.capital", COUNTRY),
    ("place.country.code", COUNTRY),
    ("place.country.continent", COUNTRY),
    ("place.country.continent_code", COUNTRY),
    ("place.country.coords", COUNTRY),
    ("place.country.currencies", COUNTRY),
    ("place.country.demonym", COUNTRY),
    ("place.country.driving_side", COUNTRY),
    ("place.country.european_union", COUNTRY),
    ("place.country.flag", COUNTRY),
    ("place.country.independent", COUNTRY),
    ("place.country.iso3", COUNTRY),
    ("place.country.landlocked", COUNTRY),
    ("place.country.languages", COUNTRY),
    ("place.country.name", COUNTRY),
    ("place.country.native", COUNTRY),
    ("place.country.numeric", COUNTRY),
    ("place.country.official", COUNTRY),
    ("place.country.population", COUNTRY),
    ("place.country.postal_format", COUNTRY),
    ("place.country.postal_regex", COUNTRY),
    ("place.country.start_of_week", COUNTRY),
    ("place.country.timezones", COUNTRY),
    ("place.country.tlds", COUNTRY),
    ("place.country.translations", COUNTRY),
    ("place.country.un_member", COUNTRY),
    ("place.country.un_region", COUNTRY),
    ("place.country.un_subregion", COUNTRY),
